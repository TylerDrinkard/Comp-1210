import java.util.Scanner;
	/**
	* Exchanges letters from user input then displays input
   * in accordance to user selection.
	*
...
{
	/**
	* Allows user to input message then according to
   * selection the message in the selected choice
   * to standard output.
	*
